...
public class TyprCasting03 {
	public static void main(String[] args) {
		// 문자열 => 다른자료형으로 형변환
	     ...
	     char result5 = "abc".charAt(0); //인덱스 번호
	     boolean result6 = Boolean.parseBoolean("true");// TRUE, true, True/대소문자 상관x
	     boolean result7 = Boolean.parseBoolean(""); //false
	     //parseBoolean() 메소드는 문자열울 boolean값으로 변환한다
