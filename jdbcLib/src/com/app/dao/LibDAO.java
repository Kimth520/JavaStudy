...
//	   - 사용자 등록 join 준혁
	public void join(UserDTO userDTO) {
	      String query = "INSERT INTO TBL_USER2(user_number, user_id, user_pw, " + 
	   "user_name, user_phone) " + "VALUES(seq_user2.NEXTVAL, ?, ?, ?, ?)";
	      try {
...
//				System.out.println("로그인한 유저 넘버 : " +  userNumber);
			}
...
//	   - 도서 등록 addBook 형우
	public void addBook(BookDTO bookDTO) {
		String qurey = "INSERT INTO TBL_BOOK " + "VALUES(SEQ_BOOK.NEXTVAL, ?, ?)";
...
// 도서 대여 메소드
	public void rental(int userNum, int bookNum, int day) {
		String sql = "INSERT INTO TBL_RENTAL values(seq_rental.nextVal, ?, ?, sysdate, ?)";
		...
		try {
			...
			System.out.println("rental 메소드 실패");
		} finally {
			try {
				preparedStatement.close();
				connection.close();
